...
<body>
  <fieldset>
    ...
    <form action="lab06_42.php" method="post" enctype="multipart/form-data" id='frm1'>
      <table align="center">
        <tr>
  ...
  ?>
    <div class="info">Lỗi<br />
      ...
      if (checkPassWord($password) == false)
        echo "Định dạng password sai!<br>";
      if (checkPhone($phone) == false)
        echo "Định dạng phone sai!<br>";
      if (checkMyDate($date) == false)
        echo "Định dạng date sai!<br>";
      ?>
